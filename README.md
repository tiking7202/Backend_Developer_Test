Bookstore API: Dự án này là một API quản lý sách đơn giản, sử dụng Django và PostgreSQL. API cho phép người dùng thực hiện các thao tác CRUD (Tạo, Đọc, Cập nhật, Xóa) đối với dữ liệu sách.
